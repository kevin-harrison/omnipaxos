use super::{state_cache::StateCache, ConfigLog, QuorumConfig};
use crate::{
    ...
    T: Entry,
{
    ...
    pub(crate) fn get_config_log(&self) -> ConfigLog {
        self.state_cache.config_log
    }
